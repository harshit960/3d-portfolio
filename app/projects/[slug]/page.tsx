              ...
              <div className="flex items-center justify-between flex-wrap gap-4">
                <div>
                  ...
                  <div className="flex space-x-3">
                    <Link 
                      href={`https://x.com/intent/tweet?text=Check out this article:${encodeURIComponent(metadata.title)}&url=${encodeURIComponent(typeof window !== 'undefined' ? window.location.href : '')}`}
                      target="_blank"
                      rel="noopener noreferrer"
                      className="p-2 bg-[#21262d] rounded-full text-[#c9d1d9] hover:bg-primary hover:text-white transition-colors"
                    >
                    ...
                    <Link href="#" className="p-2 bg-[#21262d] rounded-full text-[#c9d1d9] hover:bg-primary hover:text-white transition-colors">
                      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
